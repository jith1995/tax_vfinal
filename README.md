...
## Resident/NRI chooser

The main Start Filing CTAs open a two-option chooser. Resident Indian opens `tax-tool.html`; NRI / Overseas Indian opens `nri-tax-tool.html`. Pricing buttons continue to open the connected Tally lead form.


## Launch audit fixes added
- Google Analytics gtag added sitewide: G-PC1W2BG3E4.
- Article hub and CTA links cleaned to real .html URLs.
- Dead Login link removed.
- Footer links connected to real pages.
- Privacy, Terms, Security, Contact, About and Refund Policy stub pages added.
- Canonical URLs, robots.txt and sitemap.xml updated for www.yourcapartner.com.
- FAQ schema added to article pages from existing FAQ content.
